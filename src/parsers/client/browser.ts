...
const browsers: Browsers = jsonpack.unpack(require("../../../fixtures/regexes/client/browsers.json"));
const browserEngines: BrowserEngines = jsonpack.unpack(require("../../../fixtures/regexes/client/browser_engine.json"));
