...
const browsers: Browsers = require("../../../php_modules/device-detector/regexes/client/browsers.json");
const browserEngines: BrowserEngines = require("../../../php_modules/device-detector/regexes/client/browser_engine.json");
