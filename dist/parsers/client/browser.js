...
const browsers = jsonpack.unpack(require("../../../fixtures/regexes/client/browsers.json"));
const browserEngines = jsonpack.unpack(require("../../../fixtures/regexes/client/browser_engine.json"));
